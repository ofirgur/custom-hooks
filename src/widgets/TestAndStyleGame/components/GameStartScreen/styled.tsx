...
. Automatic critical CSS: styled-components keeps track of which components are rendered on a page
...
If the component is unused (which tooling can detect) and gets deleted, 
all its styles get deleted with it.

. Simple dynamic styling: adapting the styling of a component based on its props or a global 
...
export const GameStartScreenTitleStyled = styled.h1`
    color: #FFF;
    text-align: center;
`;